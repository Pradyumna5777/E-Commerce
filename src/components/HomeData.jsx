  ...
  return (
    ...
    <div className="grid grid-cols-4 gap-[2vw] text-black transition-all ease-in-out">
      {data.map((e, index) => {
        return (
          <div key={index}>
            <div className="md:min-h-[70vh] h-[45vh] shadow-xl flex flex-col items-center gap-[4vh] w-[48vw] md:mt-4 mt-6 md:w-[20vw] overflow-hidden relative border-[#0000001b] border-[1px]">
              <div
