        ...
        >
          {apiThirdData == "" ? (
            ...
            apiThirdData.map((e, index) => {
              return (
                <div key={index}>
                  <div className="md:h-[72vh] h-[45vh] shadow-xl flex flex-col items-center gap-[4vh] w-[48vw] md:mt-4 mt-6 md:w-[20vw] overflow-hidden relative border-[#0000001b] border-[1px]">
                    <div onClick={() => tileBtn(e, index)} className="relative">
                      <img
                        className="md:h-[35vh] h-[12vh] cursor-pointer md:w-[20vw] w-[100%] object-cover hover:scale-[1.1] hover:rounded-b-[6px] transition duration-300 ease-out"
                        src={e.image}
                      />
                      {e.discount ? (
